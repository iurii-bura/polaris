...
const ApiSpecificationsFacts: FunctionComponent<ApiSpecificationsFactsProps> = ({ apiSpecifications }): ReactElement => {
            ...
            {!apiSpecifications || apiSpecifications.length === 0 ? (
              ...
              <>
                {apiSpecifications.map((api, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center justify-between p-3 bg-base-200/50 rounded-lg">
                      <div className="flex items-center gap-3">
