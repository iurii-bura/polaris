                            ...
                            <div className="pl-6 space-y-2 text-sm">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="badge badge-secondary badge-sm">
                                        {cmdbFacts.applicationCategory}
                                    </span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="font-medium">Data Classification:</span>
                                    <span
                                        className={`badge ${getDataClassColor(cmdbFacts.dataClassification)} badge-sm`}
                                    >
                                    ...
                                    <div className="p-3 bg-base-200/30 rounded">
                                        ...
                                        <div className="space-y-1 text-xs">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <a
                                                    href={`mailto:${cmdbFacts.owner.businessOwner.email}`}
                                    ...
                                    <div className="p-3 bg-base-200/30 rounded">
                                        ...
                                        <div className="space-y-1 text-xs">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <FiMail className="w-3 h-3" />
                                                <a
                                                    href={`mailto:${cmdbFacts.owner.technicalOwner.email}`}
                                                    className="text-primary hover:underline"
                                                >
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            {cmdbFacts.vendor.supportContact ? (
                                                <div>
                                                    ...
                                                    <a
                                                        href={`mailto:${cmdbFacts.vendor.supportContact}`}
